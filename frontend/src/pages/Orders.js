            ...
            {orders.map(order => (
              <div key={order._id} className="order-card">
                ...
                <div style={{marginBottom: '1.25rem'}}>
                  {order.orderItems.map((item, index) => (
                    <div key={index} style={{
                      ...
                      />
                      <div style={{flex: 1}}>
                        <h4 style={{fontSize: '0.95rem', fontWeight: 600, color: 'var(--text)', marginBottom: '0.25rem'}}>{item.name}</h4>
                ...
                <div style={{
                  ...
                  <div>
                    <p style={{marginBottom: '0.25rem', color: 'var(--text-muted)', fontSize: '0.85rem'}}>
                      Shipping to:
                    </p>
